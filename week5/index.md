...
* *Lines* make up the grid structure my marking out columns (vertical lines) and rows (horizontal lines).
...
<!-- .slide: data-background-image="https://upload.wikimedia.org/wikipedia/commons/5/55/Assistent.jpg" -->
### Google uses cards


<!-- .slide: data-background-image="https://upload.wikimedia.org/wikipedia/commons/thumb/f/fe/Windows_10_build_10565..png/640px-Windows_10_build_10565..png" -->
...
* Spend 5 minutes having a look at some popular card based websites or apps
...
<!-- .slide: data-background-image="../images/bg-mouse.jpg" -->
### Event more suggestions from google
